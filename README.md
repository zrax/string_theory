...
- A faster version of `std::string`.  String Theory was never designed to be
  ...
  cases, and `ST::format` is usually significantly faster than alternatives
  such as `boost::format`.
...
string_theory supports a variety of platforms and compilers.  As of December
